        ...
        for search_for_index, search_for in enumerate(search_list):
            ...
            for listing in listings:
                try:
                    ...
                    type_of_guns_xpath = '//div[contains(@class,"bfdHYd Ppzolf OFBs3e")]//span[@class="JpCtJf"]'
                    power_in_kw_xpath = '//div[contains(@class,"bfdHYd Ppzolf OFBs3e")]//span[@class="NiVgee WAmrC "]'
